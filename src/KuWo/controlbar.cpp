...
{
    setStyleSheet("QSlider::sub-page:Horizontal { background-color: gold; }"
                  "QSlider::add-page:Horizontal { background-color: #333333; }"
                  "QSlider::groove:Horizontal { background: transparent; height:3px; }"
                  "QSlider::handle:Horizontal { width:10px; height:10px; border:1px solid #ffffff; border-radius:5px; background:white; margin:-5px 0px -5px 0px; }"
