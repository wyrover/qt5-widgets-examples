...
AddTabButton::AddTabButton(TabWidget* tabWidget, MyTabBar* tabBar)
    : ToolButton(tabBar)
    , m_tabBar(tabBar)
    ...
    , m_closedTabsManager(new ClosedTabsManager)
{
    ...
    m_tabBar = new MyTabBar(m_window, this);
    setTabBar(m_tabBar);
    ...
    connect(m_tabBar, &MyTabBar::tabMoved, this, &TabWidget::tabWasMoved);
...
MyTabBar* TabWidget::tabBar() const
{
    return m_tabBar;
}
