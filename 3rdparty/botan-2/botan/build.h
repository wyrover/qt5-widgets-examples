...
* 'configure.py --cc=msvc --cpu=x86 --enable-static-library --msvc-runtime=MT --prefix=../dist'
*
* Target
*  - Compiler: cl /MT /bigobj /EHs /GR /O2 /Oi
*  - Arch: x86_32
*  - OS: windows
*/
...
#define BOTAN_INSTALL_PREFIX R"(../dist)"
...
#define BOTAN_LINK_FLAGS "/MT /bigobj"
